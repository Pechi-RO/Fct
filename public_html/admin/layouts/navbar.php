    ...
    <div class="collapse navbar-collapse" id="navbarColor01">
      ...
      <?php
          if(isset($_SESSION['usuario'])){
            echo '<a href="../index.php?logout=si" class="btn btn-danger"><i class="fa fa-right-from-bracket"></i></a>';
          }else{
            echo '<a href="../login.php" class="btn btn-primary"><i class="fa fa-right-from-bracket"></i></a>';
          }
          ?>
